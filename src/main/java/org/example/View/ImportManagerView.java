 ...
 * @author ADMIN
 */
public class ImportManagerView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImportManagerView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
