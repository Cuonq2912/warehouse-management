...
public class SupplierPanel extends JPanel {
    ...
    private void initListeners() {
        ...
        btnUpdate.addActionListener(e -> {
            ...
            if (row < 0) {
                JOptionPane.showMessageDialog(parentFrame, "Please select a supplier to update", "Error",
        ...
        btnDelete.addActionListener(e -> {
            int row = tblSuppliers.getSelectedRow();
            if (row < 0) {
                JOptionPane.showMessageDialog(parentFrame, "Please select a supplier to delete", "Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
            Long id = Long.valueOf(tblSuppliers.getValueAt(row, 0).toString());
