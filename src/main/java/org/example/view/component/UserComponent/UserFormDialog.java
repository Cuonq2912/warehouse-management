    ...
    private void initListeners() {
        btnSave.addActionListener(e -> {
            ...
            if (!Pattern.matches("^(0[1-9][0-9]{8,9})$", phone)) {
                JOptionPane.showMessageDialog(this, "Invalid phone number format", "Validation Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (!isEdit || !username.equals(controller.getUserById(userId).getUsername())) {
                if (controller.existsByUsername(username)) {
                    JOptionPane.showMessageDialog(this, "Username already exists", "Validation Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
            ...
            if (isEdit) {
                ...
                if (currentUser != null && currentUser.getId().equals(userId)) {
                    UserModel updatedUser = controller.getUserById(userId);
