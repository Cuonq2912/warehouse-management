...
public class UserController {
    ...
    public void addUser(String username, String password, String fullName, String email, String phone, String address,
        ...
        if (!ValidateUtil.isValidPhone(phone)) {
            JOptionPane.showMessageDialog(viewComponent, "Số điện thoại không hợp lệ!", "Lỗi",
        ...
        if (success) {
            JOptionPane.showMessageDialog(viewComponent, "Thêm người dùng thành công!", "Success",
                    JOptionPane.INFORMATION_MESSAGE);
            loadUsers(userTable);
        } else {
            JOptionPane.showMessageDialog(viewComponent, "Thêm người dùng thất bại!", "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    }

    public void updateUser(Long id, String username, String password, String fullName, String email, String phone,
            String address, Role role, Status status) {
        ...
        if (success) {
            JOptionPane.showMessageDialog(viewComponent, "Cập nhật thành công!", "Success",
                    JOptionPane.INFORMATION_MESSAGE);
            loadUsers(userTable);
        } else {
    ...
    public void deleteUser(Long id) {
        int confirm = JOptionPane.showConfirmDialog(viewComponent, "Bạn có chắc chắn muốn xóa?", "Xác nhận",
                JOptionPane.YES_NO_OPTION);
        if (confirm == JOptionPane.YES_OPTION) {
            boolean success = userService.deleteUser(id);
            if (success) {
                JOptionPane.showMessageDialog(viewComponent, "Xóa thành công!", "Success",
                        JOptionPane.INFORMATION_MESSAGE);
                loadUsers(userTable);
            } else {
